...
public class Proc3_Graphics_09_PaintingEllipsesWithPulsatingSize extends PApplet {
  int size = 10;
  int sizeInc = 1;
  
  public static void main(String[] args){
      PApplet.main("algorithm.wenhan_homework.processing.Proc3_Graphics_09_PaintingEllipsesWithPulsatingSize");
  }
