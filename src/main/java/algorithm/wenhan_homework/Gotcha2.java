...
public class Gotcha2 extends PApplet {
    ...
    public static void main(String[] args){
        PApplet.main("algorithm.wenhan_homework.Gotcha2");
    }
    ...
    public void setup() {
        ...
        diskList.add(new Disk(10, 2, 0, 0, 0, 255));
        diskList.add(new Disk(20, 1, 2, 255, 0, 0));
        diskList.add(new Disk(30, 2, 1, 0, 255, 0));
        this.draw();
    }
